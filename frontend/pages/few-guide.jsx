...
export default function Home() {
  ...
  const sendPrompt = async (e) => {
    ...
    try {
      ...
      const res = await apiPost("/api/generate_few_guide", { prompt: e });
      ...
      <section style={{ marginTop: 24 }}>
        ...
        <div style={{ marginTop: 8, display: "flex", gap: 8 }}>
          ...
          <button
            onClick = {() => {
              setActiveBtn("expert");
              sendPrompt({target_audience: "내국인 아동", language: "한국어"});
            }}
          ...
          <button
            onClick = {() => {
              setActiveBtn("expert");
              sendPrompt({target_audience: "외국인 아동", language: "영어"});
            }}
            className={activeBtn === "expert" ? "btn active" : "btn"}
          >
            외국인 아동
         ...
         <div>
          <button
            onClick = {() => {
              setActiveBtn("expert");
              sendPrompt({target_audience: "내국인 일반", language: "한국어"});
            }}
            className={activeBtn === "expert" ? "btn active" : "btn"}
          >
            내국인 일반
          ...
          <button
            onClick = {() => {
              setActiveBtn("expert");
              sendPrompt({target_audience: "외국인 일반", language: "영어"});
            }}
            className={activeBtn === "expert" ? "btn active" : "btn"}
          >
            외국인 일반
          ...
          <button
            onClick = {() => {
              setActiveBtn("expert");
              sendPrompt({target_audience: "내국인 시니어", language: "한국어"});
            }}
            className={activeBtn === "expert" ? "btn active" : "btn"}
          >
            내국인 시니어
          ...
          <button
            onClick = {() => {
              setActiveBtn("expert");
              sendPrompt({target_audience: "외국인 시니어", language: "영어"});
            }}
            className={activeBtn === "expert" ? "btn active" : "btn"}
          >
            외국인 시니어
          ...
          <button
            onClick = {() => {
              setActiveBtn("expert");
              sendPrompt({target_audience: "내국인 전문가", language: "한국어"});
            }}
            className={activeBtn === "expert" ? "btn active" : "btn"}
          >
            내국인 전문가
          ...
          <button
            onClick = {() => {
              setActiveBtn("expert");
              sendPrompt({target_audience: "외국인 전문가", language: "영어"});
            }}
            className={activeBtn === "expert" ? "btn active" : "btn"}
          >
            외국인 전문가
